{% set structural_queries = [
    ...
    "select 'raw_payments' as source_table, 'id' as column_name, 'Null ID' as error_description, current_timestamp() as tuva_last_run from " ~ ref('raw_payments') ~ " where id is null"
] %}
